...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('dashboard_asset') }}/lib/summernote/summernote-bs4.css" rel="stylesheet">
    ...
    <!-- Ck editor -->
    <script src="{{ asset('dashboard_asset') }}/lib/ckeditor/ckeditor.js"></script>
  </head>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Reserve Dropdown</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('uploads/profile_photos') }}/{{ Auth::user()->profile_photo }}" class="wd-32 rounded-circle" alt="profile photo">
            </a>
